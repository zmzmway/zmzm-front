export const SHEET_STYLES = {
  ...
  close: "ring-offset-background focus:ring-blue-500 data-[state=open]:bg-bg-neutral absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none",
